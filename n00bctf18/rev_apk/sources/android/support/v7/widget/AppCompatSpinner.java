...
public class AppCompatSpinner extends Spinner implements TintableBackgroundView {
    ...
    L_0x004c:
        r3 = r2;
        r5 = ATTRS_ANDROID_SPINNERMODE;	 Catch:{ Exception -> 0x0067 }
        r5 = r9.obtainStyledAttributes(r10, r5, r11, r1);	 Catch:{ Exception -> 0x0067 }
        r3 = r5;
        r5 = r3.hasValue(r1);	 Catch:{ Exception -> 0x0067 }
        if (r5 == 0) goto L_0x005f;
    L_0x005a:
        r5 = r3.getInt(r1, r1);	 Catch:{ Exception -> 0x0067 }
        r12 = r5;
    L_0x005f:
