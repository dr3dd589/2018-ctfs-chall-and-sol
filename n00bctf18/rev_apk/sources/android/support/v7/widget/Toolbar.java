...
public class Toolbar extends ViewGroup {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        marginStartIndex2 = titleWidth;
        if (shouldLayout(this.mSubtitleTextView)) {
            height = childState;
            marginStartIndex2 = Math.max(marginStartIndex2, measureChildCollapseMargins(this.mSubtitleTextView, widthMeasureSpec, width + titleHorizMargins, heightMeasureSpec, titleHeight + i, collapsingMargins));
            titleHeight += this.mSubtitleTextView.getMeasuredHeight() + getVerticalMargins(this.mSubtitleTextView);
            childState = View.combineMeasuredStates(height, this.mSubtitleTextView.getMeasuredState());
    ...
    /* JADX WARNING: Missing block: B:51:0x015c, code:
