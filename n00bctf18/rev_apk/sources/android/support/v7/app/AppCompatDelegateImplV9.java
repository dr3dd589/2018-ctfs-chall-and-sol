        ...
        if (a.hasValue(R.styleable.AppCompatTheme_windowActionBar)) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (this.mOverlayActionMode) {
                    viewGroup = (ViewGroup) inflater.inflate(R.layout.abc_screen_simple_overlay_action_mode, null);
                } else {
                    viewGroup = (ViewGroup) inflater.inflate(R.layout.abc_screen_simple, null);
                }
                subDecor = viewGroup;
