    ...
    private void getWidgetsToSolveTraversal(ArrayList<ConstraintWidget> widgetsToSolve, ConstraintWidget widget) {
        if (!widget.mGroupsToSolver) {
            ...
            if (!widget.isFullyResolved()) {
                ...
                for (ConstraintAnchor targetAnchor : widget.mListAnchors) {
                    ConstraintAnchor targetAnchor2 = targetAnchor2.mTarget;
                    if (targetAnchor2 != null) {
                        ConstraintWidget targetWidget = targetAnchor2.mOwner;
                        if (!(targetAnchor2 == null || targetWidget == widget.getParent())) {
