...
public class ViewPager extends ViewGroup {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:115:0x01db  */
    /* JADX WARNING: Removed duplicated region for block: B:114:0x01d8  */
    /* JADX WARNING: Removed duplicated region for block: B:118:0x01eb  */
    /* JADX WARNING: Removed duplicated region for block: B:129:0x021e  */
    ...
    L_0x025d:
        r19 = r4;
        r0 = r21.getResources();	 Catch:{ NotFoundException -> 0x026c }
        r2 = r21.getId();	 Catch:{ NotFoundException -> 0x026c }
        r0 = r0.getResourceName(r2);	 Catch:{ NotFoundException -> 0x026c }
        goto L_0x0275;
    L_0x026c:
        r0 = move-exception;
        r2 = r21.getId();
        ...
        if (this.mPageMargin > 0 && this.mMarginDrawable != null && this.mItems.size() > 0 && this.mAdapter != null) {
            ...
            while (pos < lastPos) {
                ...
                if (pos == ii.position) {
                    ...
                    drawAt = this.mAdapter.getPageWidth(pos);
    ...
    L_0x005e:
        r3 = r17;
        r4 = -r3;
        r4 = r15.canScrollHorizontally(r4);
