    ...
    void draw(Canvas canvas) {
        ...
        if (this.mRunning || this.mFinishTime > 0) {
            ...
            if (this.mRunning) {
                ...
                drawTriggerWhileFinishing = false;
                boolean drawTriggerWhileFinishing2 = ((float) (width / 2)) * INTERPOLATOR.getInterpolation(finishProgress / 100.0f);
                boolean clearRadius = drawTriggerWhileFinishing2;
                elapsed2 = elapsed;
                this.mClipRect.set(((float) cx) - drawTriggerWhileFinishing2, 0, ((float) cx) + drawTriggerWhileFinishing2, (float) height);
